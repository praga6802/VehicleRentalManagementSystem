...
public class Bike extends Vehicle {
	...
	String[][] bikeModel1 = { { "Suzuki Access 125", "Suzuki Burgmann Street", "Suzuki Avenis" }, // suzuki scooters
	...
	public void showBikeBrandsList() {
		...
		String[] bikeBrandList=getBikeBrand1(); //getting all bike brands
		for(int i=0;i<bikeBrandList.length;i++) {
			System.out.print(bikeBrandList[i]);
			if(i<bikeBrandList.length-1) {
				System.out.print(", ");
			}
		}
	}
	...
	public void showBikeModelsList(String bikeBrandAvl) {
		String[] bikeBrandsList = bikeBrand1;
		String[][] bikeModelsList=bikeModel1;
